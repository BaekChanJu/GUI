...
public class Drink extends JPanel{
	...
	void initial() {
		...
		menu[0] = new JButton("코카콜라  ₩1,500", new ImageIcon("src\\z_과제\\imgs\\png.png"));
		menu[1] = new JButton("코카콜라 제로  ₩1,500" ,new ImageIcon("src\\z_과제\\imgs\\zer.png"));
		menu[2] = new JButton("스프라이트  ₩1,500",new ImageIcon("src\\z_과제\\imgs\\사이_195354.png"));
		menu[3] = new JButton("아이스 아메리카노  ₩1,500",new ImageIcon("src\\z_과제\\imgs\\아아.png"));
		menu[4] = new JButton("바닐라 라떼  ₩4,200",new ImageIcon("src\\z_과제\\imgs\\바닐라.png"));
