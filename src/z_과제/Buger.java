...
public class Buger extends JPanel{
	...
	void eventproc() {
		...
		menu[0] = new JButton("불고기버거  ₩2,300", new ImageIcon("src\\z_과제\\imgs\\불.png"));
		menu[1] = new JButton("빅맥  ₩4,900" ,new ImageIcon("src\\z_과제\\imgs\\빅.png"));
		menu[2] = new JButton("상하이버거  ₩4,900",new ImageIcon("src\\z_과제\\imgs\\상png.png"));
		menu[3] = new JButton("베이컨디럭스버거  ₩5,800",new ImageIcon("src\\z_과제\\imgs\\베.png"));
		menu[4] = new JButton("슈비버거  ₩5,800",new ImageIcon("src\\z_과제\\imgs\\슈.png"));
		menu[5] = new JButton("1955버거  ₩6,000 ",new ImageIcon("src\\z_과제\\imgs\\19.png"));
		for (int i=0; i<menu.length; i++) {
